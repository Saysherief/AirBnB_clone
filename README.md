![AirBnB clone](https://tse3.mm.bing.net/th?id=OIP.Zb8OOZbkmDiG03GTjw4uhQHaEU&pid=Api&P=0&w=300&h=300)
...
## Storage
The classes are handled by the abstracted storage engine defined in the [FileStorage class](https://github.com/Saysherief/AirBnB_clone/blob/master/models/engine/file_storage.py)
...
```
## Testing
Unittests are defined in the tests folder. To run the entire test suite simultaneously, execute the following command:
